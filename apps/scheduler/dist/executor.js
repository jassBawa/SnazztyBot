import { getExecutableDcaStrategies, recordDcaExecution, updateDcaStrategyAfterExecution, incrementStrategyFailures } from '@repo/database/dca';
...
async function executeDcaStrategy(strategy) {
    ...
    try {
        ...
        if (!balanceCheck.sufficient) {
            throw new Error(`Insufficient balance: Need ${balanceCheck.required.toFixed(4)} SOL ` +
...
export async function executeDcaStrategies() {
